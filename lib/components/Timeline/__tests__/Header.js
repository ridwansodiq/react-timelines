...
describe('<Header />', function () {
  ...
  describe('sticky', function () {
    it('ensures the scroll left postion gets updated when a new scrollLeft prop is received', function () {
      ...
      var wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_Header.default, props));
    ...
    it('calls the setHeaderHeight() prop when mounted', function () {
      ...
      (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_Header.default, props));
