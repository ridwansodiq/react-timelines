...
describe('<TrackKey />', function () {
  describe('side component', function () {
    var sideComponent = /*#__PURE__*/_react.default.createElement("span", {
    ...
    it('renders the side component if "sideComponent" exists', function () {
      ...
      var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_TrackKey.default, {
        track: track,
  ...
  describe('link button', function () {
    ...
    it('does not render when "sideComponent" is present', function () {
      var track = {
        ...
        isOpen: true,
        hasButton: true,
        sideComponent: /*#__PURE__*/_react.default.createElement("span", null, "Component")
      };
      var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_TrackKey.default, {
        track: track,
        clickTrackButton: jest.fn()
  ...
  describe('toggle button', function () {
    ...
    it('renders when "track.isOpen" is defined', function () {
      ...
      var wrapper = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_TrackKey.default, props));
